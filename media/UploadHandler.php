...
class UploadHandler
{
    ...
    function __construct($options = null, $initialize = true, $error_messages = null) {
        ...
        $this->options = array(
            ...
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')).'/uploads/images/',
            'upload_url' => $this->get_full_url().'/uploads/images/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            ...
            'image_versions' => array(
                ...
                */
                ...
                'thumbnail' => array(
                    ...
                    'crop' => $this->crop,
                    'max_width' => $this->width,//80,
                    'max_height' => $this->height,//80
                )
            )
        );
        if ($options) {
