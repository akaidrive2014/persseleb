	...
	*/ ?>
	<div class="row">
		<div class="col-md-8">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="heading_b">Home Banner Sliding</div>
					<div id="latest-images" class="owl-carousel owl-theme">
						<div class="item">
							<img class="img-thumbnail" src="<?php echo $this->baseTheme();?>/admin/tisa/assets/img/gallery/Image001_tn.jpg" alt="">
							<center>
								<a href="Edit">Edit</a> &nbsp; <a href="delete">Delate</a>
							</center>
						</div>
						<div class="item">
							<img class="img-thumbnail" src="<?php echo $this->baseTheme();?>/admin/tisa/assets/img/gallery/Image001_tn.jpg" alt="">
		...
		<div class="col-md-8">
			<div class="panel panel-default">
				<div class="panel-body">
					<div class="heading_b">Banners</div>
					<div id="latest-images" class="owl-carouselx owl-theme">
						<div class="item">
							<img style="float: left;" class="img-thumbnail" src="<?php echo $this->baseTheme();?>/admin/tisa/assets/img/gallery/Image001_tn.jpg" alt="">
							<div style="float: left;">
								&nbsp;<a href="Edit" title="Edit"><i class="glyphicon glyphicon-edit"></i></a>
								&nbsp;
								<a href="delete" title="Delete"><i class="glyphicon glyphicon-trash"></i></a>
								&nbsp;&nbsp;
							</div>
						</div>
						<div class="item">
