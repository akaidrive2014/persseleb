			...
			$.post($('#<?php echo $this->modelName;?>-form').attr('action'),$('#<?php echo $this->modelName;?>-form').serialize(),function(response){
				if(response.success==true){
					...
					if(response.SBPageBanner_banner_title){ 
						$("#SBPageBanner_banner_title.form-control").addClass('error'); 
						$('#SBPageBanner_banner_title_em_').html(response.SBPageBanner_banner_title).show(); 
					}else{ 
						$("#SBPageBanner_banner_title.form-control").removeClass('error'); 
						$('#SBPageBanner_banner_title_em_').hide(); 
					}
					if(response.SBPageBanner_banner_image){ 
						$("#SBPageBanner_banner_image.form-control").addClass('error'); 
						$('#SBPageBanner_banner_image_em_').html(response.SBPageBanner_banner_image).show(); 
					}else{ 
						$("#SBPageBanner_banner_image.form-control").removeClass('error'); 
						$('#SBPageBanner_banner_image_em_').hide(); 
					}
				}
				$("#savex").attr({
					'disabled':false,
