				...
				<div class="logo-advertisement">
					<div class="container">
						...
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="index-2.html"><img src="<?php echo $this -> baseUrl(); ?>/themes/front/default/images/logo.png" alt=""></a>
						</div>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav navbar-left">
								...
								<li class="drop"><a class="home" href="index-2.html">Home</a>
												...
												<div class="posts-filtered-block">
													<div class="owl-wrapper">
														...
														<div class="owl-carousel" data-num="4">
															...
															<div class="item news-post standard-post">
																<div class="post-gallery">
																	<img src="<?php echo $this -> baseUrl(); ?>/themes/front/default/upload/news-posts/art6.jpg" alt="">
																</div>
																<div class="post-content">
															...
															<div class="item news-post standard-post">
																<div class="post-gallery">
																	<img src="<?php echo $this -> baseUrl(); ?>/themes/front/default/upload/news-posts/art9.jpg" alt="">
																</div>
																<div class="post-content">
																	<h2><a href="single-post.html">Donec nec justo eget felis facilisis fermentum. </a></h2>
																	<ul class="post-tags">
								...
								<li class="drop"><a class="features" href="#">Features</a>
									<ul class="dropdown features-dropdown">
										...
										<li class="drop"><a href="#">Header Layouts</a>
											<ul class="dropdown level2">
												<li><a href="index-2.html">Default header</a></li>
